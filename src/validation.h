...
#ifndef YBTC_VALIDATION_H
#define YBTC_VALIDATION_H
...
static const uint64_t MIN_BLOCK_GAS_LIMIT = 1000000;
static const uint64_t MAX_BLOCK_GAS_LIMIT = 1000000000;
static const uint64_t DEFAULT_BLOCK_GAS_LIMIT = 40000000;

static const uint64_t MIN_MIN_GAS_PRICE = 1;
static const uint64_t MAX_MIN_GAS_PRICE = 10000;
...
/** Global variable that points to the smart contract (protected by cs_main) */
extern std::unique_ptr<sc::State> pState;
...
bool CallContract(sc::Address scAddr, std::vector<unsigned char> opcode, std::vector<unsigned char>* output, bool fStateChange = false);
