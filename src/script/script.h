...
#ifndef YBTC_SCRIPT_SCRIPT_H
#define YBTC_SCRIPT_SCRIPT_H
...
static const unsigned int MAX_SCRIPT_ELEMENT_SIZE = 128000; // jyan fabcoin is 520;
...
public:
    ...
    /**
     * Pre-version-0.6, Ybtc always counted CHECKMULTISIGs
