// Copyright (c) 2015-2016 The Ybtc Core developers
...
void TorControlConnection::eventcb(struct bufferevent *bev, short what, void *ctx)
{
    ...
    if (what & BEV_EVENT_CONNECTED) {
        ...
        if (what & BEV_EVENT_ERROR) {
            //jyan LogPrint(BCLog::TOR, "tor: Error connecting to Tor control socket\n");
        } else {
...
/****** Ybtc specific TorController implementation ********/
...
void TorController::disconnected_cb(TorControlConnection& _conn)
{
    ...
    //jyan LogPrint(BCLog::TOR, "tor: Not connected to Tor control port %s, trying to reconnect\n", target);
